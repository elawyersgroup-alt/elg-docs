...
PENDING = [
    ...
    ("Решить: скачать ГПЗУ из лота по Брусилова в российское окно", "к карточке торгов 2025 года приложен ГПЗУ — высший уровень источника в справке; самый слабый из трёх текстов станет сильным. Сервер торгов с текущей сети не отвечает; содержимого файла Code не видел и в текст о нём ничего не вписал", "wait"),
