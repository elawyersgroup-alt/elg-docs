...
PENDING = [
    ("Ссылка ЮKassa на 2 900 ₽ (Г1а) и рабочее время для оферты", "ЮKassa не отвечает из-под VPN hidemy.name: отключить VPN, затем ссылку создаёт Игорь или Code в открытой сессии; без двух подстановок страница не публикуется", "late"),
