...
PENDING = [
    ("Проверить страницу проверки на телефоне и выгрузить архив на Hostland", "elg-site-upload-2026-09-17.zip в загрузках: 52 HTML, sitemap.xml, img/samples; счёт ЮKassa № 1450084-2 и рабочее время уже подставлены; цели Метрики создать в счётчике", "late"),
