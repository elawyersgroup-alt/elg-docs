...
PENDING = [
    ...
    ("Бот проверен в Telegram 18.09: /start, кнопка и автоответ работают", "десять кнопок в нужном порядке, «Прислать номер участка» отвечает, текст с «77:» вызывает автоответ со ссылками на оплату; номер уходит и в операторскую ленту", "go"),
