...
PENDING = [
    ('Закон.ру: статья о 700-ПП расходится с сайтом — «два основания», «акт Госинспекции» и неверная фраза о 46-П; править — по слову Игоря', 'на сайте исправлено 26.09 (d66d9db): было «КС признал подп. 1 п. 4 ст. 378.2 НК не соответствующим Конституции» — в резолютивной части 46-П норма «не противоречащей Конституции». На Закон.ру «Сезонность» уже новая, блок оснований прежний', 'wait'),
    ...
    ('Статья о ВРИ: план утверждён и отправлен Игорю целиком — черновик пишет Игорь, Code правит и публикует', 'RABOTA-vri-pereocenka-snt-2026-09-26.md, раздел 1а. Пометки «проверить» (письма Росреестра и Минстроя, лимит 25 % в ПЗЗ, СКЭС ВС и 42-П) Code сверяет по первоисточникам при правке', 'wait'),
