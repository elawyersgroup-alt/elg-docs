...
PENDING = [
    ...
    ('1966-ПП и группа кадастровой оценки: сообщения ДЭПиР скачаны — перечня групп в них нет; где собственник видит группу — 237-ФЗ', '15 информационных сообщений ДЭПиР (март–сентябрь 2026) — решения Мосгорсуда: 289 решений, ~760 пунктов перечней 2021–2026 (elg-pzz/out/depr_soobshcheniya). Группа — в отчёте ГКО в фонде данных (ст. 14 237-ФЗ), разъяснения ГБУ — 30 дней (ст. 20), исправление ошибки — ст. 21 → уточнение перечня (п. 3.14 257-ПП). Поиск фонда данных по номеру — не проверен; следующий шаг — реальный объект через НСПД', 'wait'),
