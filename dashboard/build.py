...
PENDING = [
    ...
    ('700-ПП: 30 писем и лист конвертов готовы — просмотр перед печатью и отправка (Игорь, 06–08.10)', 'в «Загрузках»: 700pp-pisma-pilot-2026-09-25.docx (по письму на страницу A4, А — 15, Б — 15) и 700pp-konverty-pilot-2026-09-25.docx (индекс, адрес, «Собственнику объекта недвижимости» — в порядке писем). По правке Игоря 25.09: адрес в письме — обычный почтовый вид из государственного адресного реестра ФНС (ГАР), индекс оттуда же; кадастровый номер в карточке ГАР сверен с объектом (у помещения — с номером здания по НСПД); без индекса или с несовпавшим номером — в резерв (заменены три объекта пилота). У 12 объектов дороже 300 млн второй абзац — с одной суммой («ставка одна и для организации, и для гражданина»). Суммы «около» округлены до тысячи, стоимость — как в ЕГРН на 25.09.2026', 'wait'),
