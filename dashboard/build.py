...
PENDING = [
    ('700-ПП, «Сезонность»: второе предложение новой редакции расходится с 863-ПП — ждёт решения Игоря', 'новая редакция Игоря 26.09 (цикл 2027: первый аванс — до 28 мая) проверена: первое предложение верно (п. 1 ст. 383 НК в ред. 425-ФЗ); второе — «потерял внесудебную часть года» — расходится с первоисточником: постановление Правительства Москвы от 31.03.2026 № 863-ПП исключило объекты из перечня на 2026 год и «распространяется на правоотношения, возникшие с 1 января 2026 г.» — внесудебное исключение в течение года действует на весь год. На сайте и на Закон.ру пункт не заменён до решения; точный вариант — в отчёте 26.09', 'wait'),
