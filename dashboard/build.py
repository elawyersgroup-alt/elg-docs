...
PENDING = [
    ("Сайт: порядок заказа развёрнут и выгружен 21.09 в 00:12", "кнопки на обеих страницах ведут в бота за номером участка, ссылку на оплату даёт бот; оферта в том же коммите (b9f73b0); на живом сайте проверено — ссылок на кассу 0", "go"),
