...
PENDING = [
    ('Главная: объёмная карта участка, фактурный поиск, «С чем приходят к нам», меню «Услуги», изъятие 2026 — готово, ждёт слова Игоря на выкладку', 'собрано 26.09 из главной Игоря (glavnaya-kartinki-2026-09-26.zip): объёмная карта участка с торгов — контуры ЕГРН, окрестности из НСПД, высота зданий условно по этажности (пояснения и подпись утверждены Игорем 26.09); светлый фактурный блок поиска; «С чем приходят к нам» — сеткой в стиле orbital; меню «Услуги» не выходит за край экрана (правка общей оболочки — все 60 страниц); таблица — «магазины, бытовое обслуживание, культура, спорт»; карточка календаря и раздел «Изъятие для государственных нужд в Москве в 2026 году» — тексты Игоря, схема по округам (636 актов с датой 2026 года, 58 без номеров). Снимки 1280 и 390 — у Игоря. Перед выкладкой — вопросы: карточка календаря (с 2027 года сроки по 425-ФЗ — 28 мая и 28 марта), «опубликованные» в подписи схемы (считали по дате акта), «схема», а не «карта», в описании картинки', 'wait'),
    ('Аудит перед покупкой: строка «Выкуп помещения у города по льготе» (216-ФЗ) выложена 26.09', 'текст Игоря (teksty/audit-stroka-216fz.md), сверен с текстом закона: ч. 6–7 ст. 2 Закона № 159-ФЗ и ч. 5–6 ст. 57 Закона № 218-ФЗ в ред. 216-ФЗ, ст. 6 — с 01.03.2027; выложено заменой файла со сверкой SHA-256, живой сайт 81 из 81; проверка — в ТЗ (Г4) с 01.03.2027. Уточнение к тексту — Игорю: при рассрочке срок идёт с полной оплаты и погашения записи о залоге', 'go'),
