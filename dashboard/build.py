...
PENDING = [
    ('700-ПП: пилот отобран 25.09 — 30 объектов и 15 в резерве, до срока 02.10', 'впервые включённые в перечень на 2026 год с учётом поправок, нежилые, кадастровая стоимость от 100 млн ₽ по НСПД, частная собственность, одно письмо на здание; порядок случайный и воспроизводимый (зерно 20261002). В пилоте 19 зданий, 10 помещений, 1 сооружение; стоимость от 107 млн до 8,4 млрд ₽, медиана 195 млн; объект в «Сколково» заменён из резерва (решение Игоря 25.09); варианты писем А и Б — по 15; один объект — из дополнения 191-ПП. Налог посчитан двумя цифрами: для организации — 2 %, для гражданина — 1,5 %, свыше 300 млн — 2 %. Учёт — только elg-pzz/outreach/700pp-pilot.csv. Из 569 просмотренных номеров отпали: 483 — стоимость меньше 100 млн, 24 — государственная или неизвестная собственность, 14 — нет в НСПД, 3 — адрес или здание уже были', 'go'),
    ('700-ПП: 30 писем готовы — проверить и отправить (Игорь, 06–08.10)', 'файл 700pp-pisma-pilot-2026-09-25.docx в «Загрузках» (и в elg-pzz/outreach/pisma-700pp): по письму на страницу A4, 15 — вариант А, 15 — вариант Б; текст — раздел 1 TEKSTY в правке Игоря от 25.09, абзац Б — раздел 1Б; суммы «около» округлены до тысячи, кадастровая стоимость — как в ЕГРН, дата сведений — 25.09.2026. Адрес в письме — как в перечне (с «вн тер г»); для конверта нужен почтовый индекс. У 10 объектов дороже 300 млн сумма для организации и для гражданина одинакова (2 % в обоих случаях) — фраза повторяет одну цифру; если нужна другая формулировка для этих писем — текст Игоря', 'wait'),
