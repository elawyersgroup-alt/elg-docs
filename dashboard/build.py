...
PENDING = [
    ...
    ("«Диус»: участок подтверждён по проектной декларации — 77:09:0004006:11; раздел 1 справки за Игорем", "декларация № 77-003017 от 17.09.2026 (наш.дом.рф): нежилое здание «МФК и ТЦ», жилых помещений 0 м², разрешение на строительство 77-105000-019964-2021 от 29.12.2021, аренда до 14.07.2026 (по декларации — два месяца назад), высота 75 м как в записи зоны 2017 года. Зона 10510213 (книга 3): жилых видов нет; СЗЗ «Мосгортранса» с 03.04.2026 — 15 %, жильё в ней запрещено; ППТ 981-ПП — 1 613 кв. м под сервитут. Письмо риелтору — абзац правит Игорь, без «зона не менялась с 2017» (правило 14)", "wait"),
    ("Первый заказ с формы (22.09, 15:11) — участок в Московской области: ответить клиенту и проверить оплату (Игорь)", "Г1а, участок в Московской области (по НСПД через прокси); исполнитель поставил «нужны руки — не Москва». По оферте: сказать до начала работы и вернуть оплату, если была. Контакт — в письме о заказе в ящике", "late"),
