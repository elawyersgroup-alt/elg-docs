...
PENDING = [
    ...
    ("Пять целей Метрики", "pay_click_g1a, tg_click_g1, audit_to_g1a, pay_click_g2, tg_click_g3 — тип «JavaScript-событие»", "late"),
    ...
    ("Директ: кампания на страницу проверки, 5 000 ₽ на две недели", "фразы и объявления — teksty/kanaly-2026-09-18.md, раздел 4; критерий: ≥3 pay_click_g1a и одна оплата", "wait"),
