...
PENDING = [
    ...
    ("Российское окно: одним заходом — индекс, ЮKassa, бот", "замер 18.09: выход через Норвегию, туннель Connected, yookassa.ru и puzzlebot.top не отвечают (маршрут, не сайт); гасит VPN Игорь, дальше Code делает всё три дела подряд", "late"),
    ("Вставить тексты: ЮKassa после оплаты, сценарий PuzzleBot, две услуги Яндекс.Бизнеса", "teksty/kanaly-2026-09-18.md; Code вставит в российском окне, Яндекс.Бизнес — за Игорем", "wait"),
    ...
    ("Индекс актов: 21.09.2026 исполняется две недели", "правило RUNBOOK — пересобирать старше двух недель; совпадает с днём старта показов, нужно российское окно; разумно пересобрать 20–21.09 до первых кликов", "late"),
