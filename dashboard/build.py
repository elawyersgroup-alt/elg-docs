...
PENDING = [
    ("Проверить на телефоне: главная, проверка, Градпрофиль", "опубликовано 17.09 23:30 из elg-site (1052d55); кнопки ведут на счета ЮKassa № 1450084-2 и № 1450084-3", "go"),
    ("Создать пять целей в Метрике", "pay_click_g1a, tg_click_g1, audit_to_g1a, pay_click_g2, tg_click_g3 — тип «JavaScript-событие»; без них клики не считаются", "late"),
    ...
    ("Решить судьбу ekspress-razbor.html.bak на сервере", "отдаётся публично (200): дубль старой страницы, не утечка; удалить или закрыть", "wait"),
    ...
    ("Аккаунты на Авито и Яндекс Услугах; Яндекс.Бизнес — две новые услуги", "тексты объявлений готовы (раздел 2 текстов 17.09); цены только из PRICE.md", "wait"),
