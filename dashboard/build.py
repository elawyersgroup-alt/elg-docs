...
PENDING = [
    ...
    ("Пять целей Метрики: кнопка «Добавить цель» в сессии отключена", "проверить права логина Elanskiylgor79 на счётчик 110859643 или добавить из приложения; идентификаторы: pay_click_g1a, tg_click_g1, audit_to_g1a, pay_click_g2, tg_click_g3", "late"),
    ...
    ("Директ: черновик кампании после теста платежа", "Code собирает черновик в сессии по слову Игоря; запуск и бюджет 5 000 ₽ — только Игорь; тексты — kanaly-2026-09-18.md, раздел 4", "wait"),
