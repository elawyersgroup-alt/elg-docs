...
PENDING = [
    ...
    ('Статья о ВРИ: правки приняты, лимит 25 % подтверждён — публикация ждёт решения о странице продукта Р5', 'teksty/statya-vri-2026-09-26.md; 25 % — подп. 4 п. 3.3.5 книги 1 ПЗЗ, 9 ААС 28.04.2026 № 09АП-5705/2026 приводит дословно; призыв — страница «Проверка ВРИ» ещё не сделана', 'wait'),
    ...
    ('Отчёт ГКО Москвы № 1/2025: группа по объекту найдена; ЦАО — перечень 700-ПП почти целиком в группах 4, 6, 18', 'Группы ГКО против перечня 700-ПП, кадастровый район 77:01 (по адресам перечня — ЦАО: Басманный, Тверской, Пресненский, Замоскворечье, Таганский, Хамовники…). Группа по объекту — архив «Определение кадастровой стоимости ОН», папка «3 Результаты группировки ОН» (КН, тип, группа/подгруппа, код вида использования). Здания района: 20\xa0037; из перечня 2026 года — 5\xa0427, в отчёте ГКО нашлись 5\xa0347; из них в группах 4, 6, 18 — 4\xa0071 (76,1 %), в других группах — 1\xa0276. Нежилые помещения района: 277\xa0655; из перечня — 4\xa0989, нашлись 4\xa0969; в группах 4, 6, 18 — 4\xa0628 (93,1 %), в других — 341. Зданий района', 'wait'),
