...
PENDING = [
    ...
    ("Директ: решить судьбу черновика № 714560547", "прогноз по 9 фразам — около 326 показов в месяц на Москву и область; черновик собран (2 500 ₽ в неделю, 21.09–04.10, только Поиск), не запущен; на счёте 108 ₽", "late"),
