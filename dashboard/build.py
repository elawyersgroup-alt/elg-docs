...
PENDING = [
    ...
    ("Выписка ЕГРН по пилотному участку (580 ₽)", "нужна первая живая XML-выписка: проверить разбор, снять запрет с Г1б", "wait"),
    ("Оферта Г1а: НДС, рабочие часы, банковские реквизиты", "проект teksty/oferta-proverka-izyatie-krt-2026-09-17.md, скобки вписывает Игорь", "wait"),
    ("Сайт: страница проверки и прайс", "прайс утверждён 17.09 — блокировка снята; план готовит Claude в чате", "go"),
...
CANON = ["ничего не додумывать: не найдено — UNKNOWN, а не «нет ограничений»", "у каждого вывода [Certain] / [Likely] / [Speculation]", "выписка ЕГРН — источник истины, индекс актов — опережающий сигнал",
         ...
         "цены и ТЗ меняет только Игорь; скрипты читают config_price.json", "клиентские данные — только в приватном elg-pzz"]
