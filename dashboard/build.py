...
PENDING = [
    ('700-ПП: скачать шесть поправок к перечням — нужно «да»', 'официальные PDF с mos.ru, всего около 1,9 МБ: 520-ПП от 18.03.2025 (498 553 байт), 1481-ПП от 01.07.2025 (333 007), 2771-ПП от 18.11.2025 (159 811) — поправки к перечню на 2025 год; 191-ПП от 17.02.2026 (491 903), 863-ПП от 31.03.2026 (157 761), 1838-ПП от 07.07.2026 (308 756) — к перечню на 2026 год. Нужны, чтобы не взять в пилот объект, исключённый из перечня на 2026 год или включённый в 2025 год поправкой. Без «да» не скачиваются', 'wait'),
    ('700-ПП: какую ставку писать в письме — решение Игоря', 'по тексту законов Москвы в редакции от 26.11.2025 (docs.cntd.ru): организации — 2 % от кадастровой стоимости с 2023 года (закон № 64, ст. 2); физлица — 1,5 % по объектам из перечня и 2 % по любым объектам дороже 300 млн (закон № 51, ст. 1). Кто собственник — организация или человек, — по открытым сведениям НСПД не видно. В выборке налог посчитан по 2 %, как в плане', 'wait'),
    ('Директ: минус-слова на кампанию «Проверка перед покупкой» — нужно «да»', 'отчёт по поисковым запросам снят 25.09. После минус-фраз 23.09 (-карта, -поиск !по) за 24–25.09 — 1 051,71 ₽ и 7 кликов, из них 711,98 ₽ и 5 кликов — не наши: выписка из ЕГРН, кадастровая стоимость, кому принадлежит участок, участок в Московской области. По делу — 2 клика про ограничения на участке. Предложение: минус-слова выписка, егрн, собственник, владелец, принадлежит, найти, посмотреть, местоположение; минус-фразы «кадастровая стоимость», «план участка», «кадастровый учет», «московской области». За месяц такие запросы стоили 1 379,03 ₽ из 2 190,89. Автотаргетинга в отчёте нет — переносить во фразы нечего. В кампании ничего не менялось', 'wait'),
